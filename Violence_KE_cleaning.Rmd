...
drops <- c('X', 'GWNO', 'EVENT_ID_CNTY', 'EVENT_ID_NO_CNTY', 'TIME_PRECISION', 'ALLY_ACTOR_1', 'ALLY_ACTOR_2', 'INTER1', 'INTER2', 'INTERACTION', 'GEO_PRECISION')
...
```{r}
write.csv(data, '~/Documents/DS-Projects/R/Meta-Violence/clean_violence_KE_two.csv')
```
